...
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
  ...
  📲  companion: web (Mac OS · Desktop)
     ...
     devices — those are still revoked blind; WA_BROWSER=android (pair
     again) makes WhatsApp send the media too.
  🧠  ai       : gemini → grok
  💾  memory   : 168 MB RSS
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
```
...
4. Test the guard, as owner:
   ...
   > WhatsApp does not send one-time media to a web-class linked device, so the bot
   > never sees those bytes — it still revokes the message, because a revoke needs only
   > the message key. `!stats` shows them under `of which one-time media`. If you want
   > the bot to actually receive them, set `WA_BROWSER=android` and pair again.
